...
import { CalendarDays, Check, CreditCard, Download, FileText, ReceiptText } from "lucide-react";
...
export function CardDetailsDialog({ open, card, transactions, onClose, onExport, onPayInvoice }: CardDetailsDialogProps) {
