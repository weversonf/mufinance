...
export default function FinanceDashboard() {
  ...
  const handleConnectAccount = () => {
    ...
    action("Conta conectada", "A conta foi adicionada à sua lista.");
  };
